...
import {
  inicializarDocumentosPDF,
  actualizarFechaPDF,
  actualizarCodigoPDF,
  actualizarDatosCabeceraPDF,
  actualizarConfiguracionPDF,
  actualizarSVGPDF,
  actualizarTablaMaterialesPDF,
  actualizarTotalesPDF,
  actualizarPatronesCorte,
  actualizarTablaPesoPDF,
  actualizarTotalesPesoPDF
} from './pdfUpdater.js';
